...
<body>
    ...
    <section data-aos="zoom-out" style="text-align: center;">
        <h1 class="bg-light" style="padding: 25px;">Read information</h1>
        <div class="container">
            <div class="row-1 justify-content-center align-items-start">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <?php foreach ($data['information'] as $table) : ?>
                        <tr>
                            <td><?php echo $table->i_email;?></td>
                            <td><?php echo $table->i_message;?></td>
                            <td><?php echo $table->i_date;?></td>
                        </tr>
                        <?php endforeach ;?>
                    </table>
                </div>
