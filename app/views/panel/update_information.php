...
<body>
    ...
    <section data-aos="zoom-out" style="text-align: center;">
        <h1 class="bg-light" style="padding: 25px;">Update information</h1>
        <div class="container">
            <div class="row justify-content-center align-items-start">
                <div class="col">
                    <form method="post" action="<?php echo URLROOT ;?>/panel/update_information">
                        <div class="form-group"><input class="form-control" type="text" data-bs-hover-animate="pulse" placeholder="New email" name="email" value="<?php echo $data['information']->i_email;?>" required=""></div>
                        <div class="form-group"><input class="form-control" type="text" data-bs-hover-animate="pulse" placeholder="New message" name="message" value="<?php echo $data['information']->i_message;?>" required=""></div>
