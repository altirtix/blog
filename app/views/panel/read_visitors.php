...
<body>
    ...
    <section data-aos="zoom-out" style="text-align: center;">
        <h1 class="bg-light" style="padding: 25px;">Read visitors</h1>
        <div class="container">
            <div class="row-1 justify-content-center align-items-start">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <?php foreach ($data['visitors'] as $table) : ?>
                        <tr>
                                <td><?php echo $table->v_ip;?></td>
                                <td><?php echo $table->v_active;?></td>
                                <td><?php echo $table->v_date;?></td>
                        </tr>
                        <?php endforeach ;?>
                    </table>
                </div>
